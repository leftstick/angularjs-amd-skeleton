var hljs = new function() {
    ...
    function c(T, L, J, R) {
        ...
        function N() {
            ...
            var U = "";var X = 0;
            I.lR.lastIndex = 0;var V = I.lR.exec(C);
            while (V) {
                U += j(C.substr(X, V.index - X));var W = E(I, V);
                if (W) {
                    H += W[1];
                    U += w(W[0], j(V[0]))
                } else {
    ...
    function e(y, x) {
        x = x || b.languages || Object.keys(f);var v = {
            r: 0,
            value: j(y)
        };var w = v;x.forEach(function(z) {
            if (!i(z)) {
                return
            }
            var A = c(z, y, false);
    ...
    function p(A) {
        ...
        var z = y.textContent;var v = B ? c(B, z, true) : e(z);var x = u(y);
        if (x.length) {
...
hljs.registerLanguage("bash", function(b) {
    ...
    d.splice(d.length, 0, b, f);return {
        c: d,
        k: e,
        i: "\\S"
    }
